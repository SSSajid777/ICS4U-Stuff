...
Name: Sajid Abdullah
Date: 16 June, 2026
Description: Power-O-Pong is a two player pong game where players use paddles to hit a ball
back and forth. Every 4-hit streak spawns a random powerup (player speed increase,
opponent speed decrease, or player size increase) that lasts until the next powerup
spawns. First to 7 points wins.
Resources: Images generated by ChatGPT
Paddle and ball images: https://github.com/nuno-faria/pong-game
