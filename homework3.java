...
public class homework3 {
    public static void main(String[] args) {
        ...
        System.out.print("Enter a positive interger to output that number of stars"); // how do i Uses a for loop to
                                                                                      // print a growing triangle
                                                                                      // pattern of stars, where the
                                                                                      // first line has 1 star, the
                                                                                      // second line has 2 stars, and so
                                                                                      // on, until the nth line has n
                                                                                      // stars.
